...
public class AtlasGraphSONUtility {
    ...
    private AtlasGraphSONUtility(final AtlasGraphSONMode mode, final Set<String> vertexPropertyKeySet,
        ...
        this.includeReservedEdgeType = includeReservedKey(mode, AtlasGraphSONTokens._TYPE, edgePropertyKeys, this.edgePropertiesRule);
        this.includeReservedEdgeLabel = includeReservedKey(mode, AtlasGraphSONTokens._LABEL, edgePropertyKeys, this.edgePropertiesRule);
        this.includeReservedEdgeOutV = includeReservedKey(mode, AtlasGraphSONTokens._OUT_V, edgePropertyKeys, this.edgePropertiesRule);
        this.includeReservedEdgeInV = includeReservedKey(mode, AtlasGraphSONTokens._IN_V, edgePropertyKeys, this.edgePropertiesRule);
    }
    ...
    private ObjectNode objectNodeFromElement(final AtlasElement element) {
        ...
        if (element instanceof AtlasEdge) {
            ...
            if (this.includeReservedEdgeType) {
                jsonElement.put(AtlasGraphSONTokens._TYPE, AtlasGraphSONTokens.EDGE);
            }
            ...
            if (this.includeReservedVertexType) {
                jsonElement.put(AtlasGraphSONTokens._TYPE, AtlasGraphSONTokens.VERTEX);
            }
        }
