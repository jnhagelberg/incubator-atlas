...
public abstract class DeleteHandler {
     ...
     */
    public void deleteEntity(AtlasVertex<?,?> instanceVertex) throws AtlasException {
    ...
    protected abstract void deleteEdge(AtlasEdge<?,?> edge) throws AtlasException;
     ...
     * @throws AtlasException
     */
    protected void deleteTypeVertex(AtlasVertex<?,?> instanceVertex, DataTypes.TypeCategory typeCategory) throws AtlasException {
        switch (typeCategory) {
        case STRUCT:
        case TRAIT:
            deleteTypeVertex(instanceVertex);
     ...
     * @throws AtlasException
     */
    protected <V,E> void deleteTypeVertex(AtlasVertex<V,E> instanceVertex) throws AtlasException {
    ...
    public void deleteReference(AtlasEdge<?,?> edge, IDataType dataType, AttributeInfo attributeInfo) throws AtlasException {
        deleteReference(edge, dataType.getTypeCategory(), attributeInfo.isComposite);
    }

    public void deleteReference(AtlasEdge<?,?> edge, DataTypes.TypeCategory typeCategory, boolean isComposite) throws AtlasException {
    ...
    protected void deleteEdge(AtlasEdge<?,?> edge, boolean updateReverseAttribute) throws AtlasException {
    ...
    protected <V,E> void deleteVertex(AtlasVertex<V,E> instanceVertex, DataTypes.TypeCategory typeCategory) throws AtlasException {
    ...
    protected abstract void _deleteVertex(AtlasVertex<?,?> instanceVertex);
