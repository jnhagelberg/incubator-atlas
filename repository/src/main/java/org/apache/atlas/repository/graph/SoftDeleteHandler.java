...
public class SoftDeleteHandler extends DeleteHandler {
    ...
    @Override
    protected void _deleteVertex(DeleteContext context, AtlasVertex<?,?> instanceVertex, boolean force) {
        if (force) {
    ...
    @Override
    protected void deleteEdge(DeleteContext context, AtlasEdge<?,?> edge, boolean force) throws AtlasException {
        if (force) {
