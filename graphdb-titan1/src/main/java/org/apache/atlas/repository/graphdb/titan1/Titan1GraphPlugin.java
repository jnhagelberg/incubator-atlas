...
//      ScriptEngine engine =  mgr.getEngineByName("gremlin-groovy");
//      if(engine == null) {
//          //ensure engine is registered
//          GremlinGroovyScriptEngineFactory factory = new GremlinGroovyScriptEngineFactory();
//          mgr.registerEngineName(factory.getLanguageName(), factory);
//      }
        //GremlinLoader.load();
        SugarLoader.load();
    }
